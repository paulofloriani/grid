...
-->
    ...
    <body>
        ...
        <main class="container">
            <?php echo form_open_multipart(base_url('painel/verifica_registro_produto'),'name="form_registro_produto"  '); ?>
                ...
                <div class="row  right-align" style="margin-top:40px;">
                    ...
                    <div class="input-field col s6">
                        ...
                        <?php echo form_input(array('name'=>'onu','id'=>'onu'),  set_value('onu'),'autofocus enable placeholder="Informe o número da ONU do produto"');?>
                            <?php  echo form_error('onu');?>
                                <label>ONU<span class="red-text"><stronger>*</stronger></span></label>
                    </div>
                    <div class="input-field col s6">

                        <?php echo form_input(array('name'=>'classe','id'=>'classe'),  set_value('classe'),'autofocus enable placeholder="Informe o número da classe do produto"');?>
                            <?php  echo form_error('classe');?>
                                <label>Classe<span class="red-text"><stronger>*</stronger></span></label>
                    </div>
                    <div class="input-field col s6">

                        <?php echo form_input(array('name'=>'guia','id'=>'guia'),  set_value('guia'),'autofocus  enable placeholder="Informe o número do GUIA do produto"');?>
                            <?php  echo form_error('guia');?>
                                <label>Número GUIA<span class="red-text"><stronger>*</stronger></span></label>
                    </div>
                    <div class="input-field col s6">

                        <?php echo form_input(array('name'=>'nome','id'=>'nome'),  set_value('nome'),'autofocus  enable placeholder="Informe o nome do produto"');?>
                            <?php  echo form_error('nome');?>
                                <label>Nome do Produto<span class="red-text"><stronger>*</stronger></span></label>
                    </div>
                    <div class="input-field col s6 right">
                        <p>
                            <?php echo form_checkbox('reag_agua', 1, set_value('reag_agua'),'id="reag_agua" onclick="desmarcar_regiao_nenhum()"');    echo form_error('reag_agua');?>
